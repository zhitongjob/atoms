...
public class CloneUtils {
	...
	public static Object clone(Object value, int level)
		...
		if (value instanceof Collection) {// 复制新的集合
			...
			if (c.equals(int[].class)) {
				...
				Object[] tmp = (Object[]) Arrays.copyOf(old, old.length,
						old.getClass());
	 ...
	 * @throws NoSuchMethodException
	 */
	public static Object clone(Object value) throws IllegalAccessException,
	 ...
	 * @throws NoSuchMethodException
	 */
	public static Object deepClone(Object value) throws IllegalAccessException,
			InstantiationException, InvocationTargetException,
			NoSuchMethodException {
		return clone(value, -1);
	}
